  ...
  <main id="app">
    <div class="header mb-3">
      <div>
        ...
        <router-link v-bind:to="{ name: 'SignIn' }" class="badge badge-primary"
          >Sign In</router-link
        >
        <router-link to="/memo-list" class="badge badge-primary"
          >Memo List</router-link
        >
        <router-link
          v-bind:to="{ name: 'SimpleForm' }"
          class="badge badge-primary"
          >Simple Form</router-link
        >
        <router-link to="/grid-view" class="badge badge-primary"
          >Grid View</router-link
        >
        <router-link to="/popper-view" class="badge badge-primary"
          >Popper View</router-link
        >
        <router-link to="/check-out" class="badge badge-primary"
...
export default {
  ...
  computed: {
    currentDateToString() {
      return this.$moment(this.currentDate * 1000)
        .locale("ja")
